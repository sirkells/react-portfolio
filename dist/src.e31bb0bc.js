...
var PROJECTS = [{
  ...
  description: "A simple blog application with authentication built with flask",
...
},{}],"data/socialProfile.js":[function(require,module,exports) {
"use strict";
...
var _socialProfile = _interopRequireDefault(require("./data/socialProfile"));
...
function (_Component2) {
  ...
  function SocialProfiles() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(SocialProfiles)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  _createClass(SocialProfiles, [{
    key: "render",
    value: function render() {
      return _react.default.createElement("div", null, _react.default.createElement("h2", null, "Connect with me?"), _react.default.createElement("div", null, _socialProfile.default.map(function (SOCIAL_PROFILE) {
...
exports.default = _default;
},{"react":"../node_modules/react/index.js","./data/socialProfile":"data/socialProfile.js"}],"assets/david.jpg":[function(require,module,exports) {
module.exports = "/david.64e47dba.jpg";
...
var TITLES = ["a Software Developer", "a football lover", "a lover of Music", "an enterprising young man"];
  ...
  function Title() {
    ...
    _defineProperty(_assertThisInitialized(_this), "animateTitle", function () {
      _this.titleInterval = setInterval(function () {
        ...
        var titleIndexInc = (titleIndex + 1) % TITLES.length;

        _this.setState({
          titleIndex: titleIndexInc,
          fadeIn: true
        });
  ...
  _createClass(Title, [{
    ...
    value: function render() {
      var _this$state2 = this.state,
          titleIndex = _this$state2.titleIndex,
          fadeIn = _this$state2.fadeIn;
...
var _david = _interopRequireDefault(require("./assets/david.jpg"));
...
function (_Component) {
  ...
  _createClass(App, [{
    ...
    value: function render() {
      ...
      var displayBio = this.state.displayBio;
...
var _default = App;
exports.default = _default;
},{"react":"../node_modules/react/index.js","./Projects":"Projects.js","./SocialProfiles":"SocialProfiles.js","./assets/david.jpg":"assets/david.jpg","./Title":"Title.js"}],"../node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
